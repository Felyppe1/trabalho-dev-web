...
@WebFilter(filterName = "SessionAuthFilter", urlPatterns = { "/home", "/extrato", "/transferir", "/transferencias", "/eu/investimentos", "/investimentos", "/statement/*", "/comprar-investimento/*", "/deposito", "/saque", "/alterar-senha"  })
